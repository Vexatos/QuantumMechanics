...
{
    [Pooled]
    public class WonkyCassetteMoveBlockDebris : Actor
    {
        ...
        private float spin;
        public WonkyCassetteMoveBlockDebris() : base(Vector2.Zero)
        {
        ...
        public WonkyCassetteMoveBlockDebris Init(Vector2 position, Vector2 center, Vector2 returnTo, Action<Image> onUpdateSprite = null)
        {
